...
import com.fluffy.samrith.university_managment_system.department.DepartmentActivity;
...
public class DepartmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setOnClick(new RowListener() {
            ...
            public void onRowClick(RowItem row) {
                ...
                switch (row.getId()){
                    case 1:
                        i = new Intent(getContext(), DepartmentActivity.class);
                        i.putExtra("func","view");
                        startActivity(i);
                        break;
                    case 2:
                        i = new Intent(getContext(), DepartmentEditActivity.class);
                        i.putExtra("func","add");
                        startActivity(i);
                        break;
                    case 3:
    ...
    private void prepareRowItemData() {
        ...
        RowItemList.add( new RowItem(4,"Delete Department","trash"));
