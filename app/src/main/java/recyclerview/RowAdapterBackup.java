...
public class RowAdapterBackup extends RecyclerView.Adapter<RowAdapterBackup.itemViewHolder> {
        private Context context ;
        private ArrayList<RowItem> rowItem;
        private RowListener rowListener;

    public RowAdapterBackup(Context context, ArrayList<RowItem> rowItem) {
